...
module.exports = function(config) {
  config.set({
    ...
    files: [
      'public/src/scripts/libs.js',
      'src/scripts/app/app.js',
      'src/scripts/app/components/*.js',
      'src/scripts/modules/**/*.js',
      'src/build/handlebars/*.js',
      'src/build/handlebars/**/*.js',
      'src/tests/vendor/ember-jasmine.js',
      'src/tests/vendor/ember-jasmine-setup.js',
    ...
    preprocessors: {
        'src/scripts/app/app.js': ['coverage'],
        'src/scripts/modules/**/*.js': ['coverage']
    },
